...
model Tload_flow_power
  ...
  parameter SI.CoefficientOfHeatTransfer gammaloss = 20;
  ...
  AES.ProcessComponents.Thermal.Liquid.surfTcond_prescribed Tloss annotation(
    Placement(visible = true, transformation(origin = {70, 50}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput T_for_loss annotation(
    Placement(visible = true, transformation(origin = {140, 50}, extent = {{20, -20}, {-20, 20}}, rotation = 0), iconTransformation(origin = {0, 120}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  AES.ProcessComponents.Thermal.Liquid.Convection_VecVec conv_loss(A = 20, gamma = gammaloss)  annotation(
