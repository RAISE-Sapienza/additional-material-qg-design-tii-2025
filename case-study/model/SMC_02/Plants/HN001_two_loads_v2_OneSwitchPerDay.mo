...
model HN001_two_loads_v2_OneSwitchPerDay
  ...
  parameter Real hod_12 = 8;
  parameter Real hod_21 = 18;
  ...
  SMC_02.Components.OneSwitchperDay gen_spTo(TC = TC, hod_12 = hod_12, hod_21 = hod_21, value1 = spTo1, value2 = spTo2)  annotation(
    Placement(visible = true, transformation(origin = {-100, 22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  SMC_02.Components.OneSwitchperDay gen_spDpHC(TC = TC, hod_12 = hod_12, hod_21 = hod_21, value1 = spDpHC1, value2 = spDpHC2)  annotation(
...
end HN001_two_loads_v2_OneSwitchPerDay;